...
export function TopNav() {
    ...
    const QuotaBadge = () => {
        ...
        if (quota) {
            if (quota.tier === 'ADMIN') {
                return (
                    <div className="px-3 py-1 rounded-full text-xs border bg-purple-600 text-white border-purple-500 font-bold">
                        {t('admin')} ∞
                    </div>
                );
            } else if (quota.tier === 'PRO') {
                return (
                    <div className="px-3 py-1 rounded-full text-xs border font-medium text-blue-400 bg-blue-900/20 border-blue-900/50">
                        Pro • {(quota.limit ?? 0) - quota.current} {t('left')}
                    </div>
                );
            } else if (quota.tier === 'PLUS') {
                return (
                    <div className="px-3 py-1 rounded-full text-xs border font-medium text-yellow-400 bg-yellow-900/20 border-yellow-900/50">
            ...
            return (
                <div className="px-3 py-1 rounded-full text-xs border bg-gray-800 border-gray-700 min-w-[80px] text-center">
